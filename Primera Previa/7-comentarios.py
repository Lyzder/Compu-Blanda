...
# Se grafican los datos antes de haber creado los modelos para
# tener un registro.
...
# Usando la función polyfit de Numpy, se crean distintos modelos que
# acomoden los datos conseguidos en distintos grados, almacenando cada
# modelo.
# La función retorna un arreglo de coeficientes, la cantidad dependiendo
# del grado del modelo. Ej: Grado 2 tendría los coeficientes a, b, c
# debido a la forma de la ecuación de 2do grado y = ax^2+bx+c.
# Si se pasa el argumento full=True, la función retorna más datos. Uno de los
# datos son el valor de los residuales, que se pueden interpretar como el
# error del modelo.
# Se combina con el uso de la clase poly1d, que permite crear polinomios
# y efectuar operaciones y evaluaciones. Recibe como argumento un arreglo
# ordenado de los coeficientes. En este caso, dicho arreglo se consigue con
# polyfit.
...
# Creación del modelo de grado 10.
f10 = sp.poly1d(np.polyfit(x, y, 10))
# Creación del modelo de grado 100.
...
# progresiva, siendo gardados como archivos independientes.
