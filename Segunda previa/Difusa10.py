...
plt.plot(0, 0, marker='o', markersize=10, color='g')
plt.plot(1, 0.2, marker='o', markersize=10, color='g')
plt.plot(2, 0.4, marker='o', markersize=10, color='g')
plt.plot(3, 0.4, marker='o', markersize=10, color='g')
plt.plot(4, 0.2, marker='o', markersize=10, color='g')
plt.plot(5, 0, marker='o', markersize=10, color='g')
plt.plot(6, 0, marker='o', markersize=10, color='g')
plt.plot(7, 0, marker='o', markersize=10, color='g')
plt.plot(8, 0, marker='o', markersize=10, color='g')
plt.plot(9, 0, marker='o', markersize=10, color='g')
